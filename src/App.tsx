        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-1 p-6 flex gap-6">
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <p className="text-sm text-muted-foreground">Lembre-se: Você pode utilizar a
                        variavel <code className="text-orange-400">{"{transcription}"}</code> no seu prompt para
                        adicionar o
                        conteudo
                        trascrito
                    </p>
                    ...
                    <form className=" space-y-6">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="transcription_prompt">
                                Prompt de trascrição
                            </Label>
                            <Textarea
                                id="transcription_promp"
                                className="h-20 leading-relaxed resize-none"
                                placeholder="Inclua Palavras-chaves menciondadas no video separadas por virgula (,)"
                            >
                            </Textarea>
                        </div>
